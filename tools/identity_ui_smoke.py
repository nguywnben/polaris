        ...
        try:
            ...
            page.on(
                ...
                lambda request: (
                    ...
                    if request.method == "POST" and "/api/identity/" in request.url
                    else None
                ),
            )
            ...
            context.route(
                ...
                lambda route: route.fulfill(status=409, json={"detail": "Synthetic conflict"}),
            )
            ...
            print(
                "PASS: five widths, vi/en, light/dark, permission items, read-only owner, "
