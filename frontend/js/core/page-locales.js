...
const PAGE_LOCALE_TRANSLATIONS = {
    en: {
        ...
        'models.virtual_model': 'Virtual Model', 'models.not_configured': 'Not configured', 'models.virtual_model_description': 'Use polaris in OpenAI, Anthropic, or Google GenAI clients. Requests try the selected models from top to bottom.', 'models.provider_models': 'Provider Models', 'models.search_models': 'Search models', 'models.unavailable_routes': 'Unavailable Model Routes',
...
const RUNTIME_UI_VALUES = {
    en: [
        ...
        'Credential {name}', 'Remove', 'Select at least one provider model to activate polaris.', 'No models match your search.',
    ...
    'zh-CN': [
        ...
        '凭据 {name}', '移除', '请至少选择一个提供商模型以启用 polaris。', '没有符合搜索条件的模型。',
    ...
    'zh-TW': [
        ...
        '憑證 {name}', '移除', '請至少選取一個供應商模型以啟用 polaris。', '沒有符合搜尋條件的模型。',
    ...
    de: [
        ...
        'Zugang {name}', 'Entfernen', 'Wählen Sie mindestens ein Provider-Modell aus, um polaris zu aktivieren.', 'Keine Modelle entsprechen Ihrer Suche.',
    ...
    es: [
        ...
        'Credencial {name}', 'Quitar', 'Selecciona al menos un modelo de proveedor para activar polaris.', 'Ningún modelo coincide con la búsqueda.',
    ...
    fr: [
        ...
        'Identifiant {name}', 'Retirer', 'Sélectionnez au moins un modèle fournisseur pour activer polaris.', 'Aucun modèle ne correspond à votre recherche.',
    ...
    id: [
        ...
        'Kredensial {name}', 'Hapus', 'Pilih setidaknya satu model penyedia untuk mengaktifkan polaris.', 'Tidak ada model yang cocok dengan pencarian.',
    ...
    it: [
        ...
        'Credenziale {name}', 'Rimuovi', 'Seleziona almeno un modello provider per attivare polaris.', 'Nessun modello corrisponde alla ricerca.',
    ...
    ja: [
        ...
        '認証情報 {name}', '削除', 'polaris を有効にするには、プロバイダーモデルを 1 つ以上選択してください。', '検索条件に一致するモデルはありません。',
    ...
    ko: [
        ...
        '자격 증명 {name}', '제거', 'polaris를 활성화하려면 공급자 모델을 하나 이상 선택하세요.', '검색 조건과 일치하는 모델이 없습니다.',
    ...
    pt: [
        ...
        'Credencial {name}', 'Remover', 'Selecione pelo menos um modelo de provedor para ativar o polaris.', 'Nenhum modelo corresponde à pesquisa.',
    ...
    ru: [
        ...
        'Учётные данные {name}', 'Удалить', 'Выберите хотя бы одну модель провайдера, чтобы активировать polaris.', 'Поиск не дал результатов.',
    ...
    th: [
        ...
        'ข้อมูลรับรอง {name}', 'นำออก', 'เลือกโมเดลของผู้ให้บริการอย่างน้อยหนึ่งรายการเพื่อเปิดใช้ polaris', 'ไม่พบโมเดลที่ตรงกับการค้นหา',
    ...
    tr: [
        ...
        'Kimlik bilgisi {name}', 'Kaldır', 'polaris modelini etkinleştirmek için en az bir sağlayıcı modeli seçin.', 'Aramanızla eşleşen model yok.',
    ...
    vi: [
        ...
        'Thông tin xác thực {name}', 'Gỡ bỏ', 'Chọn ít nhất một mô hình của nhà cung cấp để kích hoạt polaris.', 'Không có mô hình nào khớp với nội dung tìm kiếm.',
...
const OPERATION_COPY_VALUES = {
    en: [
        ...
        'Could not save polaris: {error}', 'Move model up', 'Move model down', 'Remove model',
...
const ACCESS_VIRTUAL_KEY_MESSAGES = {
    en: {
        ...
        'access.new_key_secret': 'New virtual-key secret', 'access.copy_secret': 'Copy', 'access.secret_saved': 'I saved the key',
    ...
    vi: {
        ...
        'access.new_key_secret': 'Khóa bí mật API ảo mới', 'access.copy_secret': 'Sao chép', 'access.secret_saved': 'Tôi đã lưu khóa',
...
const MODEL_ROUTING_WORKFLOW_MESSAGES = {
    en: {
        ...
        'models.route_created': 'The polaris route was created.',
        'models.route_saved': 'The polaris route was saved.',
        'models.delete_confirm': 'Delete the polaris route? Provider credentials and discovered models will not be removed.',
        'models.route_deleted': 'The polaris route was deleted.',
    ...
    vi: {
        ...
        'models.route_created': 'Đã tạo tuyến polaris.',
        'models.route_saved': 'Đã lưu tuyến polaris.',
        'models.delete_confirm': 'Xóa tuyến polaris? Thông tin xác thực và các mô hình đã phát hiện sẽ không bị xóa.',
        'models.route_deleted': 'Đã xóa tuyến polaris.',
...
const PRODUCTION_DASHBOARD_MESSAGES = {
    en: {
        ...
        'dashboard.cost_unknown': 'Cost unavailable',
        'dashboard.cost_coverage': '{source} · {priced}/{total} successful calls priced. API-equivalent estimates, not invoices.',
    ...
    vi: {
        ...
        'dashboard.cost_unknown': 'Chưa xác định chi phí',
        'dashboard.cost_coverage': '{source} · Đã tính {priced}/{total} lượt thành công. Ước tính theo giá API, không phải hóa đơn.',
