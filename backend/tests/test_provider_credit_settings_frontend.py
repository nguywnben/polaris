...
class ProviderCreditSettingsFrontendTests(unittest.TestCase):
    ...
    def test_unused_credit_ui_is_not_shipped_but_credential_status_is_preserved(self):
        ...
        self.assertNotIn('class="status-badge credit-on', cards)
        management = (ROOT / "frontend/js/ui/credential-management.js").read_text(encoding="utf-8")
        self.assertIn("credInfo.enable_credit", management)
        self.assertIn("'action_disable_credit' : 'action_enable_credit'", management)
