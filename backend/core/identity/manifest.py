...
_MANAGEMENT_ROUTE_MANIFEST = (
    ...
    *_http(
        ...
        ("POST", "/api/providers/kiro/oauth/start"),
        ("POST", "/api/providers/kiro/oauth/complete"),
        ("POST", "/api/providers/kiro/oauth/cancel"),
        ("POST", "/api/providers/muse-code/oauth/start"),
        ("POST", "/api/providers/muse-code/oauth/complete"),
        ("POST", "/api/providers/muse-code/oauth/cancel"),
        ("POST", "/api/providers/kiro/browser/start"),
        ("POST", "/api/providers/kiro/browser/complete"),
        ("POST", "/api/providers/kiro/browser/cancel"),
        ("POST", "/api/providers/kiro/browser/callback"),
        ("POST", "/api/providers/extended/{provider_id}/credentials/import"),
