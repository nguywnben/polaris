...
PANEL_PASSWORD=
SETUP_TOKEN=
SETUP_ALLOW_INSECURE_HTTP=false
...
_BOOLEAN_NAMES = frozenset(
    """PANEL_COOKIE_SECURE SETUP_ALLOW_INSECURE_HTTP TRUST_PROXY_HEADERS OIDC_ENABLED
...
_BASIC_NAMES = frozenset(
    ...
    CORS_ORIGIN_REGEX API_KEY PANEL_PASSWORD SETUP_TOKEN SETUP_ALLOW_INSECURE_HTTP
