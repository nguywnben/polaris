...
![Polaris — 控制台预览](../assets/screenshots/credential-pool.png)
...
| <img src="../../frontend/assets/providers/kimi-api-platform.png" width="18" height="18" valign="middle" /> **Kimi API Platform** | API 密钥 | Moonshot API |
