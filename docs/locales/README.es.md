...
| <img src="../../frontend/assets/providers/kimi-api-platform.png" width="18" height="18" valign="middle" /> **Kimi API Platform** | Clave API | Moonshot API |
...
El perfil básico no requiere servicios externos y guarda datos en `polaris-data`. La plantilla fija `0.1.0-beta.1`. Utilice el [procedimiento de actualización y reversión](../updating.md). Después active almacenamiento externo, OIDC, proxy, protecciones, caché o telemetría mediante `deploy/compose.advanced.yml`.
