...
| <img src="../../frontend/assets/providers/kimi-api-platform.png" width="18" height="18" valign="middle" /> **Kimi API Platform** | API-ключ | Moonshot API |
...
Базовый профиль не требует внешних сервисов и хранит данные в `polaris-data`. Шаблон закреплён на `0.1.0-beta.1`; используйте [процедуру обновления и отката](../updating.md). Расширенные функции подключаются через `deploy/compose.advanced.yml`.
