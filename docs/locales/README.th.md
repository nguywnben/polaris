...
รูปแบบพื้นฐานไม่ต้องใช้บริการภายนอกและเก็บข้อมูลใน `polaris-data` เทมเพลตเตรียมไว้สำหรับ `1.0.0` ซึ่งยังไม่เผยแพร่ ก่อนติดตั้งให้จัดการแท็ก/อิมเมจเก่าที่ชื่อซ้ำตาม[รายการตรวจสอบการเผยแพร่](../releases/1.0.0-preparation.md) ใช้[ขั้นตอนอัปเดตและย้อนกลับ](../updating.md) และเปิดตัวเลือกขั้นสูงผ่าน `deploy/compose.advanced.yml` เมื่อต้องการ
