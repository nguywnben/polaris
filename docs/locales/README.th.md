...
| <img src="../../frontend/assets/providers/kimi-api-platform.png" width="18" height="18" valign="middle" /> **Kimi API Platform** | คีย์ API | Moonshot API |
...
รูปแบบพื้นฐานไม่ต้องใช้บริการภายนอกและเก็บข้อมูลใน `polaris-data` เทมเพลตตรึงเวอร์ชัน `0.1.0-beta.1` ให้ทำตาม[ขั้นตอนอัปเดตและย้อนกลับ](../updating.md) เปิดตัวเลือกขั้นสูงผ่าน `deploy/compose.advanced.yml` เมื่อต้องการ
