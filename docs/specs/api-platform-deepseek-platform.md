# DeepSeek Platform integration

Status: implementation approved by the owner on 2026-09-15. Module: `deepseek-platform` in [the approved capability map](api-platforms-map.md).

## Objective and acceptance

Add `deepseek` as an API-key provider named **DeepSeek Platform**, linked to https://platform.deepseek.com/.
Use https://api.deepseek.com/v1 as the official default API root, with Bearer authentication.
Logo source: https://fe-static.deepseek.com/platform/favicon.svg
...
- Verify thinking/tool-history round trips explicitly; do not silently discard required reasoning history.
